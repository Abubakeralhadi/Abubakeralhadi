<?php
ob_start();
define('API_KEY','5363494944:AAHN3_VRUBc26-JsRazIr0qWYUcQtk9RRtU');
echo "api.telegram.org/bot".API_KEY."/setwebhook?url=".$_SERVER['SERVER_NAME']."".$_SERVER['SCRIPT_NAME'];

function Oxyg1($method,$datas=[]){
...
$Dev = array("2037376092","5391615479","3");
$usernamebot = "Y11Tbot";
$channel = "oxbbbbb";
$admin = 2037376092;
$channelcode = "1740510160"; // ايدي القناة الي ترسل بيها لهدايا
$token = API_KEY;
...
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎
[اضغط هنا وتابع جديدنا ، 📢](https://t.me/oxbbbbb)",
'parse_mode'=>"MarkDown",
'disable_web_page_preview'=>true,
